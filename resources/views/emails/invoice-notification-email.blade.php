<div style="padding: 24px;">
	...
	<a href="{{ $invoice_link }}" style="padding-left: 16px; padding-right: 16px; padding-top: 8px; padding-bottom: 8px; text-align: center; background-color: black; color: white; margin-top: 16px; margin-bottom: 32px; text-decoration: none;">View Invoice</a>
